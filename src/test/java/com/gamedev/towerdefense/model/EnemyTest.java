...
public class EnemyTest {
    ...
    public void testConstructor() {
        ...
        Enemy enemy = new Enemy(path, 100, 50.0f, 0);
    ...
    public void testGetPosition() {
        ...
        Enemy enemy = new Enemy(path, 50, 30.0f, 0);
    ...
    public void testGetHealth() {
        ...
        Enemy enemy = new Enemy(path, 75, 25.0f, 0);
    ...
    public void testGetSpeed() {
        Path path = new Path(Arrays.asList(new Position(0, 0)));
        Enemy enemy = new Enemy(path, 50, 40.5f, 0);
    ...
    public void testIsAlive_LowHealth() {
        Path path = new Path(Arrays.asList(new Position(0, 0)));
        Enemy enemy = new Enemy(path, 1, 50.0f, 0);
    ...
    public void testTakeDamage_ExceedsHealth() {
        Path path = new Path(Arrays.asList(new Position(0, 0)));
        Enemy enemy = new Enemy(path, 50, 50.0f, 0);
    ...
    public void testHasReachedEnd_True() {
        ...
        Enemy enemy = new Enemy(path, 100, 50.0f, 2); // Start beyond last waypoint
    ...
    public void testUpdate_Movement() {
        ...
        Enemy enemy = new Enemy(path, 100, 100.0f, 0); // Speed 100, starting at (0,0)
    ...
    public void testUpdate_ReachWaypoint() {
        ...
        Enemy enemy = new Enemy(path, 100, 200.0f, 0); // Fast enough to reach waypoint
    ...
    public void testUpdate_ReachEnd() {
        ...
        Enemy enemy = new Enemy(path, 100, 200.0f, 0);
    ...
    public void testUpdate_DiagonalMovement() {
        ...
        Enemy enemy = new Enemy(path, 100, 141.42f, 0); // Speed to cover diagonal distance
